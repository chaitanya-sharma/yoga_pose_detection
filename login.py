...
title=tk.Label(root, text="Login Here", font=("Algerian", 30, "bold","italic"),bd=5,bg="tan",fg="black")
title.place(x=180,y=190,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=40,y=300)
