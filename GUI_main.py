...
d3.place(x=500,y=110)

d3=tk.Button(root,text="Tips",command=Tips,width=20,height=1,bd=5,background="#6C7B8B",foreground="white",font=("times new roman",14,"bold"))
d3.place(x=750,y=110)
